...
export const UtilityRequest = z.object({
  ...
  method: z.enum(["health", "probe", "provider_status", "probe_claude_usage", "preflight_repository", "run_stub_workflow", "start_work_item", "list_work_items", "get_work_item", "pause", "resume", "intervene", "shutdown"]),
  payload: z.unknown()
}).strict();
